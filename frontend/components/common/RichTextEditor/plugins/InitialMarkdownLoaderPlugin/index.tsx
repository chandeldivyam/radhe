...
export function InitialMarkdownLoaderPlugin({
	initialSyncPromise,
	markdown,
}: InitialMarkdownLoaderProps) {
	...
	useEffect(() => {
		...
		if (
			...
			editor.update(() => {
				...
				if (isEmpty) {
					console.log(
						'Editor is empty after initial sync, applying suggestion markdown.'
					);
					...
					console.log(
						'Editor is not empty after initial sync, skipping initial markdown application.'
					);
